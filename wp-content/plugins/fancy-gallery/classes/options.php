...
abstract class Options {
  ...
  static function addOptionsPage(){
    ...
    static::addOptionBox(I18n::t('Permissions'), Core::$plugin_folder.'/options-page/permissions.php', 'main');
  ...
  static function loadOptionsPage(){
    ...
    if (static::saveOptions()) WP_Redirect(static::getOptionsPageUrl(Array('options_saved' => 'true')) );
